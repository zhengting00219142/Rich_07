...
#include <iostream>
using namespace std;  // use for eclipse or will show error.
#include <assert.h>
	...
	*/
	...
	public:
		...
		*/
		...
		/**
		* Function: hasCurrent
		* Description£ºcheck whether current value is NULL just for the empty iterator
		Return:
		true -- can visit current
		false -- cannot visit current
		*/
		...
		*/
		bool hasNextForUp() {
			return currentNode != NULL && currentNode->nextNode != temp;
		}
		...
		*/
		bool hasNextForBack() {
			return currentNode != NULL && currentNode->prevNode != temp;
		}
